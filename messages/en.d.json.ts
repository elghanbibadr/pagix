...
declare const messages: {
 ...
 "signup": {
   ...
   "login": {
    ...
    "description": "No problem. Enter your email and we'll send you a link to reset your password.",
    ...
    "successInstructions": "Click the link in the email to reset your password.",
    "noEmail": "Didn't receive an email? Check your spam folder or try again with a different email.",
